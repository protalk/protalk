...
class PageData extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface
{
    ...
    function load(ObjectManager $manager)
    {
        ...
        $page->setContent("Contributing to ProTalk couldn\'t be easier. All you need to do is find a video or audio recording about PHP that you enjoyed and think others could learn from, complete the form below and we\'ll take it from there.</p><p>Once we\'ve verified that we\'re allowed to embed the material, we\'ll publish it on the site and send you an email letting you know its available. Well….what are you waiting for?</p><p>If you want to help us develop ProTalk and make it even better, <a class=\"pageLink\" href=\"https://github.com/protalk/protalk\">fork us on GitHub</a> and check out the <a class=\"pageLink\" href=\"https://github.com/protalk/protalk/issues\">list of open issues</a>.");
        $manager->persist($page);
