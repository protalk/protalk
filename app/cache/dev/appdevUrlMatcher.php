...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // protalk_page_page_index
        if (preg_match('#^/page/(?P<url>[^/]+?)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Protalk\\PageBundle\\Controller\\PageController::indexAction',)), array('_route' => 'protalk_page_page_index'));
        }
