...
INSERT INTO `Media` (mediatype_id, `date`, description, `length`, rating, visits, content, slides, joindin, `language`, title, slug, isPublished ) VALUES (1, null,'A talk about peripheral tools that aid web development', '1hr 20mins', '5', '450', '<iframe src="http://player.vimeo.com/video/30012690" width="500" height="409" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>','<div style="width:425px" id="__ss_9285199"><iframe src="http://www.slideshare.net/slideshow/embed_code/9285199" width="425" height="355" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe></div>',null,'en', 'Tool Up Your Lamp Stack', 'tool-up-your-lamp-stack', '1');

INSERT INTO `Media` (mediatype_id, `date`,`length`, rating, visits, content, joindin, `language`, title, slug, isPublished ) VALUES (1, null, '40mins', '4', '32', '<iframe class="player" frameborder="0" scrolling="no" src="http://playertv-bscdn-admin.pad-playertv.brainsonic.com/web//player-html5-568.html" width="400" height="300"><noframes><img alt="&lt;h2&gt;3 Mars Session 05 Symfony&lt;/h2&gt;" src="http://playertv-bscdn-admin.pad-playertv.brainsonic.com/uploads/32/20110309-193143/photo_1.jpg" /><h2>3 Mars Session 05 Symfony</h2></noframes></iframe>','2597','en', 'phpBB4: Building end-user applications with Symfony2', 'phpbb4-building-end-user-applications-with-symfony2', '1' );

INSERT INTO `Media` (mediatype_id,`date`, description, `length`, rating, visits, content, `language`, title, slug, isPublished ) VALUES (2,'2012-05-15','A Voices of the ElePHPant Interview with Derick Rethans by Cal Evans, sponsored by EngineYard.', '11mins', '3.5', '6', 'http://voices.of.the.elephpant.s3.amazonaws.com/vote_052.mp3','en', 'Interview with Derick Rethans', 'interview-with-derick-rethans', '1');

INSERT INTO `Media` (mediatype_id,`date`, description, `length`, rating, visits, content, `language`, title, slug, isPublished ) VALUES (2,'2012-04-26','Episode 11 of the DevHell postcase series. "This time out we are blessed by the presence of Joël Perras, PHP developer extraordinaire and Fictive Kin brosef of Ed. We explore Joël’s rags-to-riches story: a young academic schlepping coffee and 44oz soft drinks at a gas station, where he’s discovered by a grizzled dev team manager in need of Java skills. From there it’s been a whirlwind of web sites, programming languages, and more ops than you can shake a stick at."', '1hr 31mins', '3.5', '6', 'http://devhell.s3.amazonaws.com/ep11-64mono.mp3','en', 'From Gas Station Attendant to Java Developer', 'from-gas-station-attendant-to-java-developer', '1');
